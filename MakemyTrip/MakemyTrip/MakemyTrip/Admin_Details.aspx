<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Details.aspx.cs" Inherits="MakemyTrip.Admin_Details" %>
...
<body class="g-sidenav-show  bg-gray-200">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="Admin_Details.aspx">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <form id="form1" runat="server">
           ...
           <div class="row">
            ...
            <asp:GridView ID="AdminView" Width="100%" runat="server" ForeColor="#333333" BorderStyle="None">
