<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Destinations.aspx.cs" Inherits="MakemyTrip.Admin_Destinations" %>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="Admin_Destinations.aspx">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="user-details">
          <div class="input-box">
            <span class="details">Destination Name</span>
                ...
                <asp:TextBox ID="Admin_destination" MaxLength="50" PlaceHolder="Enter Destination Name" runat="server" required /> 
          ...
          <div class="input-box">
            <span class="details">No of Days Nights</span> 
              ...
              <asp:TextBox ID="Admin_days" MaxLength="50" PlaceHolder="Enter No of Days Nights" runat="server" required /> 
          ...
          <div class="input-box">
            <span class="details">Description</span>
                ...
                <asp:TextBox ID="Admin_des" MaxLength="50" PlaceHolder="Enter Description " runat="server" required /> 

          </div>
          <div class="input-box">
            <span class="details">Places Name</span>

               <asp:TextBox ID="Admin_place" MaxLength="50" PlaceHolder="Enter Places Name" runat="server" required /> 
          ...
          <div class="input-box">
            <span class="details">Package Price</span>
               ...
               <asp:TextBox ID="Admin_price" MaxLength="50" PlaceHolder="Enter Package Price" runat="server" required /> 
              
          </div>
          <div class="input-box">
            <span class="details">Image Upload</span>
            
              <asp:FileUpload ID= "Des_Upload" runat = "server" required />
          ...
          <asp:RadioButton ID="Winter" runat="server" Text="Winter" GroupName="cat" />  
            <asp:RadioButton ID="Summer" runat="server" Text="Summer" GroupName="cat" />  
         <asp:RadioButton ID="Monsoon" runat="server" Text="Monsoon" GroupName="cat" />  
        
            </div>  
       
        <div class="button">
             <asp:Button  ID="desBtn" runat="server" Text="Publish" onClick="publish_des" />
...
<%--                        <div class="card-body px-0 pb-2">
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" ForeColor="#333333" BorderStyle="None">
