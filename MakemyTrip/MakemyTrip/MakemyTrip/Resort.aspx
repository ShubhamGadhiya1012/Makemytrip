<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resort.aspx.cs" Inherits="MakemyTrip.Resort" %>
   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item active"><a href="Resort.aspx" class="nav-link">Resort</a></li>
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="HomePage.aspx">Home <i class="fa fa-chevron-right"></i></a></span> <span>Resorts <i class="fa fa-chevron-right"></i></span></p>
